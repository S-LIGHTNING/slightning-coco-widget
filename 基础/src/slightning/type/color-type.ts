...
import { RuntimeColorType } from "../runtime/type/color-type"
import { ChildTypeInfo, RuntimeTypeData, Type } from "./type"
import { typeGenerateRuntimeData } from "./utils"

export class ColorType extends RuntimeColorType implements Type<string> {

    public readonly key: string = "ColorType"
    ...
    public toJSON(this: this): RuntimeTypeData {
        return typeGenerateRuntimeData(packageInfo.name, "RuntimeColorType", {})
    }
